...
Original file is located at
    https://colab.research.google.com/drive/19j_jkC_Cf51CLUqEH9bKOpCyQcJEAOTD
...
file_path = "Womens Clothing E-Commerce Reviews.csv" # change to your file
...
sns.barplot(y=tw1['Word'], x=tw1['Frequency'], palette=ourcolors)  # use our color set
